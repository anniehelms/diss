...
```{r}
data = data %>%
  mutate(dur_period = c(scale(dur_period)),
         f0_spectilt = c(scale(f0_spectilt)),
         vowel_periph = c(scale(vowel_periph)))
head(data)
```
...
```{r}
cat_model_plot= glm(stress ~ dur_period*pc1*syllable + dur_period*pc2*syllable + f0_spectilt*pc1*syllable + f0_spectilt*pc2*syllable + vowel_periph*pc1*syllable + vowel_periph*pc2*syllable,
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
set_theme(base = theme_bw())
cat_f0_syl = plot_model(cat_model_plot, type = "pred", terms = c("f0_spectilt", "syllable"), axis.title = c("F0", "% stressed"),
           title = "Catalan production - F0",
           #legend.title = "Steps",
           pred.type = "re") +
  #scale_color_discrete(labels=c('1', '2', '3', '4', '5')) +
  theme(plot.title=element_text(hjust = 0.5), legend.position = "bottom") +
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
set_theme(base = theme_bw())
cat_vowel = plot_model(cat_model_plot, type = "pred", terms = c("vowel_periph"), axis.title = c("Vowel peripherity", "% stressed"),
...
spa = data %>%
  filter(Language == "spa")
spa_model_plot= glm(stress ~ dur_period*pc1*syllable + dur_period*pc2*syllable + f0_spectilt*pc1*syllable + f0_spectilt*pc2*syllable +
                      vowel_periph*pc1*syllable + vowel_periph*pc2*syllable,
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
set_theme(base = theme_bw())
spa_pc1_f0_syllable = plot_model(spa_model_plot, type = "pred", terms = c("pc1 [all]", "f0_spectilt", "syllable"), axis.title = c("Principal Component 1", "% stressed"),
           title = "Spanish production - F0",
           #legend.title = "Steps",
           pred.type = "re") +
  #scale_color_discrete(labels=c('1', '2', '3', '4', '5')) +
  theme(plot.title=element_text(hjust = 0.5), legend.position = "bottom") +
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
set_theme(base = theme_bw())
spa_pc1_dur_syllable = plot_model(spa_model_plot, type = "pred", terms = c("pc1 [all]", "dur_period", "syllable"), axis.title = c("Principal Component 1", "% stressed"),
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
set_theme(base = theme_bw())
spa_vowel_syllable = plot_model(spa_model_plot, type = "pred", terms = c("vowel_periph", "syllable"), axis.title = c("Vowel peripherity", "% stressed"),
           title = "Spanish production - Vowel",
           #legend.title = "Steps",
           pred.type = "re") +
  #scale_color_discrete(labels=c('1', '2', '3', '4', '5')) +
  theme(plot.title=element_text(hjust = 0.5), legend.position = "bottom") +
...
eng_model_plot= glm(stress ~ dur_period*pc1*syllable + dur_period*pc2*syllable + f0_spectilt*pc1*syllable + f0_spectilt*pc2*syllable +
                      vowel_periph*pc1*syllable + vowel_periph*pc2*syllable,
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
set_theme(base = theme_bw())
eng_f0_syl = plot_model(eng_model_plot, type = "pred", terms = c("f0_spectilt", "syllable"), axis.title = c("F0", "% stressed"),
           title = "English production - F0",
           #legend.title = "Steps",
           pred.type = "re") +
  #scale_color_discrete(labels=c('1', '2', '3', '4', '5')) +
  theme(plot.title=element_text(hjust = 0.5), legend.position = "bottom") +
...
eng_lang = data %>%
  filter(Language == "eng")
eng_lang_model_plot= glm(stress ~ dur_period*lang_profile*syllable + f0_spectilt*lang_profile*syllable +
                      vowel_periph*lang_profile*syllable,
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
set_theme(base = theme_bw())
eng_lang_dur= plot_model(eng_lang_model_plot, type = "pred", terms = c("dur_period", "lang_profile"), axis.title = c("Duration", "% stressed"),
           title = "English production - Duration",
           #legend.title = "Steps",
           pred.type = "re") +
  #scale_color_discrete(labels=c('1', '2', '3', '4', '5')) +
