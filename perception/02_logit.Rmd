...
```
```{r}
cairo_pdf("figures/cat_vowel_pc1.pdf", family = "serif", width = 8, height = 4)
cat_vowel_pc1
dev.off()
```
...
cat_dur_pc1 = plot_model(model_lang_plot, type = "pred", terms = c("pc1 [all]", "duration_center"), axis.title = c("Principal Component 1", "% ponDIS"),
           title = "Catalan perception",
           legend.title = "Duration steps",
           pred.type = "re") +
  scale_color_discrete(labels=c('1', '2', '3', '4', '5')) +
  theme(plot.title=element_text(hjust = 0.5), legend.position = "bottom")
cat_dur_pc1
...
```{r}
cairo_pdf("figures/cat_dur_pc1.pdf", family = "serif", width = 8, height = 4)
cat_dur_pc1
dev.off()
```
...
cat_st_pc1 = plot_model(model_lang_plot, type = "pred", terms = c("pc1 [all]", "spectilt_center"), axis.title = c("Principal Component 1", "% ponDIS"),
           title = "Catalan perception", legend.title = "Spectral tilt steps", pred.type = "re") +
  scale_color_discrete(labels=c('1', '2', '3', '4', '5')) +
  theme(plot.title=element_text(hjust = 0.5), legend.position = "bottom")
cat_st_pc1
```
```{r}
cairo_pdf("figures/cat_st_pc1.pdf", family = "serif", width = 8, height = 4)
cat_st_pc1
dev.off()
```
